...
class GoogleSQLTool(BaseTool):
    ...
    description = """
    Useful tool to create a Google Standard SQL that answers user's question.
...
construct a Google Standard SQL (BigQuery) query statement to answer the question: :{query}
